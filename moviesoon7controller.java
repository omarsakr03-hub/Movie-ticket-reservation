...
public class moviesoon7controller {
    @FXML
    private Hyperlink soon7trailer;
    @FXML
    ...
    @FXML
    private void soon7trailer(ActionEvent event) throws IOException {
        Desktop desktop = Desktop.getDesktop();
        desktop.browse(java.net.URI.create("https://youtu.be/rze8QYwWGMs?si=sgX-5erqwLBLiBKC"));
    }
}
