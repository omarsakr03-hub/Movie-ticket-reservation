...
public class moviesoon6controller {
    @FXML
    private Hyperlink soon6trailer;
    @FXML
    ...
    @FXML
    private void soon6trailer(ActionEvent event) throws IOException {
        Desktop desktop = Desktop.getDesktop();
        desktop.browse(java.net.URI.create("https://youtu.be/nwtUswJKRs4?si=5zkpCquF_NqUxP27"));
    }
}
