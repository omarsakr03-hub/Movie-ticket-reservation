...
public class imaxcinemacontroller implements Initializable {
    ...
    private static final int SEAT_PRICE = 150; // Adjust the seat price as needed
    ...
    public double total;
    public imaxcinemacontroller() {
        // Initialization code (if any)
    }
    public imaxcinemacontroller(ListView<String> standardListView) {
    ...
    public void checker() {
        if (actiontype != null) {
            switch (actiontype) {
                case "movie1imax5pm":
                    imaxlabel.setText("TEFFIFIER - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image1);
                    imaximg.setVisible(true);
                    ShowId=4;
                    break;
                case "movie1imax8pm":
                    imaxlabel.setText("TEFFIFIER - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image1);
                    imaximg.setVisible(true);
                    ShowId=5;
                    break;
                case "movie1imax12am":
                    imaxlabel.setText("TEFFIFIER - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image1);
                    imaximg.setVisible(true);
                    ShowId=6;
                    break;
                case "movie2imax5pm":
                    imaxlabel.setText("RED ONE - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image2);
                    imaximg.setVisible(true);
                    ShowId=13;
                    break;
                case "movie2imax8pm":
                    imaxlabel.setText("RED ONE - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image2);
                    imaximg.setVisible(true);
                    ShowId=14;
                    break;
                case "movie2imax12am":
                    imaxlabel.setText("RED ONE - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image2);
                    imaximg.setVisible(true);
                    ShowId=15;
                    break;
                case "movie3imax5pm":
                    imaxlabel.setText("GLADIATOR - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image3);
                    imaximg.setVisible(true);
                    ShowId=22;
                    break;
                case "movie3imax8pm":
                    imaxlabel.setText("GLADIATOR - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image3);
                    imaximg.setVisible(true);
                    ShowId=23;
                    break;
                case "movie3imax12am":
                    imaxlabel.setText("GLADIATOR - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image3);
                    imaximg.setVisible(true);
                    ShowId=24;
                    break;
                case "movie4imax5pm":
                    imaxlabel.setText("ELHAWA SULTAN - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image4);
                    imaximg.setVisible(true);
                    ShowId=31;
                    break;
                case "movie4imax8pm":
                    imaxlabel.setText("ELHAWA SULTAN - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image4);
                    imaximg.setVisible(true);
                    ShowId=32;
                    break;
                case "movie4imax12am":
                    imaxlabel.setText("ELHAWA SULTAN - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image4);
                    imaximg.setVisible(true);
                    ShowId=33;
                    break;
                case "movie5imax5pm":
                    imaxlabel.setText("MOANA 2 - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image5);
                    imaximg.setVisible(true);
                    ShowId=40;
                    break;
                case "movie5imax8pm":
                    imaxlabel.setText("MOANA 2 - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image5);
                    imaximg.setVisible(true);
                    ShowId=41;
                    break;
                case "movie5imax12am":
                    imaxlabel.setText("MOANA 2 - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image5);
                    imaximg.setVisible(true);
                    ShowId=42;
                    break;
                case "movie6imax5pm":
                    imaxlabel.setText("ELHAREFA 2 - 5 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image6);
                    imaximg.setVisible(true);
                    ShowId=49;
                    break;
                case "movie6imax8pm":
                    imaxlabel.setText("ELHAREFA 2 - 8 PM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image6);
                    imaximg.setVisible(true);
                    ShowId=50;
                    break;
                case "movie6imax12am":
                    imaxlabel.setText("ELHAREFA 2 - 12 AM");
                    imaxlabel.setFont(Font.font("Arial", FontWeight.BOLD, 13.5));
                    imaximg.setImage(image6);
                    imaximg.setVisible(true);
                    ShowId=51;
    ...
    private void handleBackButton(ActionEvent event) throws IOException {
        ...
        Map<String, Pair<String, String>> movieScreenMap = Map.ofEntries(
                Map.entry("movie1imax5pm", new Pair<>("movienow1.fxml", "TERRIFIER 3")),
                Map.entry("movie1imax8pm", new Pair<>("movienow1.fxml", "TERRIFIER 3")),
                Map.entry("movie1imax12am", new Pair<>("movienow1.fxml", "TERRIFIER 3")),
                Map.entry("movie2imax5pm", new Pair<>("movienow2.fxml", "RED ONE")),
                Map.entry("movie2imax8pm", new Pair<>("movienow2.fxml", "RED ONE")),
                Map.entry("movie2imax12am", new Pair<>("movienow2.fxml", "RED ONE")),
                Map.entry("movie3imax5pm", new Pair<>("movienow3.fxml", "GLADIATOR")),
                Map.entry("movie3imax8pm", new Pair<>("movienow3.fxml", "GLADIATOR")),
                Map.entry("movie3imax12am", new Pair<>("movienow3.fxml", "GLADIATOR")),
                Map.entry("movie4imax5pm", new Pair<>("movienow4.fxml", "ELHAWA SULTAN")),
                Map.entry("movie4imax8pm", new Pair<>("movienow4.fxml", "ELHAWA SULTAN")),
                Map.entry("movie4imax12am", new Pair<>("movienow4.fxml", "ELHAWA SULTAN")),
                Map.entry("movie5imax5pm", new Pair<>("movienow5.fxml", "MOANA 2")),
                Map.entry("movie5imax8pm", new Pair<>("movienow5.fxml", "MOANA 2")),
                Map.entry("movie5imax12am", new Pair<>("movienow5.fxml", "MOANA 2")),
                Map.entry("movie6imax5pm", new Pair<>("movienow6.fxml", "ELHAREFA 2")),
                Map.entry("movie6imax8pm", new Pair<>("movienow6.fxml", "ELHAREFA 2")),
                Map.entry("movie6imax12am", new Pair<>("movienow6.fxml", "ELHAREFA 2"))
        );
