...
public class movienow1controller {
    ...
    @FXML
    private void now1trailer(ActionEvent event) throws IOException {
        Desktop desktop = Desktop.getDesktop();
        desktop.browse(java.net.URI.create("https://youtu.be/zaPcin5knJk?si=iCXuaXSX6OPi_4Xl"));
    }
    ...
    public void regular5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("terrifier 3 ", "125 min ", "+18", "Screen 1", "Regular", "At 5 PM");
    ...
    public void regular8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 1", "Regular", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        regularcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1regular8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 8PM");
        signup.setScene(scene);
        signup.setResizable(false);
        signup.show();
        currentStage.close();
    ...
    public void regular12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 1", "Regular", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        regularcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1regular12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 12AM");
        signup.setScene(scene);
        signup.setResizable(false);
        signup.show();
        currentStage.close();
    ...
    public void imax5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 2", "Imax", "At 5 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        controller.setActiontype("movie1imax5pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 5pm");
    ...
    public void imax8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 2", "Imax", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        imaxcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1imax8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 5pm");
    ...
    public void imax12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 2", "Imax", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        imaxcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1imax12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 12am");
    ...
    public void gold5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 3", "Gold", "At 5 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        controller.setActiontype("movie1gold5pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3  -  5pm");
    ...
    public void gold8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 3", "Gold", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        goldcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1gold8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 -  3 5pm");
        signup.setScene(scene);
        signup.setResizable(false);
        signup.show();
        currentStage.close();
    ...
    public void gold12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("TERRIFIER 3 ", "125 min ", "RATED 18+", "Screen 3", "Gold", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        goldcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie1gold12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("TERRIFIER 3 - 3 5pm");
