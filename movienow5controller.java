...
public class movienow5controller {
    ...
    @FXML
    private void now5trailer(ActionEvent event) throws IOException {
        Desktop desktop = Desktop.getDesktop();
        desktop.browse(java.net.URI.create("https://youtu.be/hDZ7y8RP5HE?si=B4jWXHXajBDHYBgA"));
    }
    ...
    public void regular5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 13", "Regular", "At 5 PM");
    ...
    public void regular8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 13", "Regular", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        regularcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5regular8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2  8PM");
        signup.setScene(scene);
        signup.setResizable(false);
        signup.show();
        currentStage.close();
    ...
    public void regular12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 13", "Regular", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        regularcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5regular12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2  12AM");
        signup.setScene(scene);
        signup.setResizable(false);
        signup.show();
        currentStage.close();
    ...
    public void imax5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 14", "Imax", "At 5 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        controller.setActiontype("movie5imax5pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 -  5pm");
    ...
    public void imax8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 14", "Imax", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        imaxcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5imax8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 -  8pm");
    ...
    public void imax12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 14", "Imax", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        imaxcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5imax12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 - 12am");
    ...
    public void gold5pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 15", "Gold", "At 5 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        controller.setActiontype("movie5gold5pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 -  5pm");
    ...
    public void gold8pmOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 15", "Gold", "At 8 PM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        goldcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5gold8pm");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 -  8pm");
    ...
    public void gold12amOnAction(ActionEvent event) throws IOException {
        ((screenclass)x).connector("MOANA 2", "100 min ", "PG (USA)", "Screen 15", "Gold", "At 12 AM");
        moviename = x.getMoviename();
        duration = x.getDuaration();
        agelimit = x.getAgelimit();
        screennumber = ((screenclass)x).getScreennum();
        ...
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        goldcinemacontroller controller = fxmlLoader.getController();
        controller.setActiontype("movie5gold12am");// Set the action type
        controller.checker();
        controller.movietransmission1(moviename,duration,agelimit,screennumber,category,timing,email);
        Stage signup = new Stage();
        signup.setTitle("MOANA 2 - 12am");
